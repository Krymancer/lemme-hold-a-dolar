...
async function getConstants(image, caption) {
...
async function writeCaption(image, caption) {
    const { blackFont, whiteFont, topOffset, bottomOffset, lineOffset, fontOffset, } = await getConstants(image, caption);
    image.print(blackFont, lineOffset.top, topOffset + fontOffset, caption.top);
    image.print(blackFont, lineOffset.top, topOffset - fontOffset, caption.top);
    image.print(blackFont, lineOffset.top + fontOffset, topOffset, caption.top);
    image.print(blackFont, lineOffset.top - fontOffset, topOffset, caption.top);
    image.print(blackFont, lineOffset.bottom, bottomOffset + fontOffset, caption.bottom);
    image.print(blackFont, lineOffset.bottom, bottomOffset - fontOffset, caption.bottom);
    image.print(blackFont, lineOffset.bottom + fontOffset, bottomOffset, caption.bottom);
    image.print(blackFont, lineOffset.bottom - fontOffset, bottomOffset, caption.bottom);
